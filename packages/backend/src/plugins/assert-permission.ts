...
export default fp(async (fastify: FastifyInstance) => {
  fastify.decorate('assertPermission', function (request: FastifyRequest, reply: FastifyReply, permission: Permission) {
...
declare module 'fastify' {
  interface FastifyInstance {
    assertPermission: (request: FastifyRequest, reply: FastifyReply, permission: Permission) => boolean;
  }
}
