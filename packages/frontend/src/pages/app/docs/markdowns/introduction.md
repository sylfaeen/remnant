...
Remnant is a lightweight and modern management panel for Minecraft servers. It allows you to control your server from an intuitive web interface.
...
Remnant is built with modern technologies:
