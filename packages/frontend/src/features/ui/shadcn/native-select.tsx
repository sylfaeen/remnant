  ...
  return (
    <div className="group/native-select relative w-fit has-[select:disabled]:opacity-50" data-slot="native-select-wrapper">
      <select
        ...
        data-size={size}
        className={cn(
          'border-input-border selection:bg-primary selection:text-primary-foreground placeholder:text-muted-foreground bg-input-bg hover:bg-input-bg/80 h-9 w-full min-w-0 appearance-none rounded-md border px-3 py-2 pr-9 text-sm shadow-xs transition-[color,box-shadow] outline-none disabled:pointer-events-none disabled:cursor-not-allowed data-[size=sm]:h-8 data-[size=sm]:py-1',
