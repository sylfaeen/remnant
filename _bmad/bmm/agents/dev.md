...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="RA or fuzzy match on rules-audit or rules or audit" workflow="{project-root}/_bmad/bmm/workflows/4-implementation/rules-audit/workflow.yaml">[RA] Rules Audit: Scan the codebase against all rules defined in .claude/rules/ and report violations with file:line references</item>
